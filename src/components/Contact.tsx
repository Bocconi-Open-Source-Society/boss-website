...
const Contact = () => {
  ...
  const [touched, setTouched] = useState({ email: false, phone: false, message: false });
  ...
  const validatePhone = (value: string) => {
    ...
    if (!v.startsWith("+")) {
      return "Use international format (e.g. +39 333 123 4567)";
    }
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (emailValidation || phoneValidation || messageValidation) {
              ...
              <form onSubmit={onSubmit} noValidate className="space-y-5 md:space-y-7">
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-4 bg-ctp-mantle/50 border rounded-xl text-ctp-text placeholder-ctp-overlay0 focus:outline-none transition-all ${emailError
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-4 bg-ctp-mantle/50 border rounded-xl text-ctp-text placeholder-ctp-overlay0 focus:outline-none transition-all ${phoneError
                      ? 'border-ctp-red focus:ring-2 focus:ring-ctp-red/50'
                      : 'border-ctp-surface1 focus:ring-2 focus:ring-ctp-lavender focus:border-transparent'
                      }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className={`w-full px-5 py-4 bg-ctp-mantle/50 border rounded-xl text-ctp-text placeholder-ctp-overlay0 focus:outline-none transition-all resize-none ${messageError
                      ? 'border-ctp-red focus:ring-2 focus:ring-ctp-red/50'
                      : 'border-ctp-surface1 focus:ring-2 focus:ring-ctp-lavender focus:border-transparent'
                      }`}
